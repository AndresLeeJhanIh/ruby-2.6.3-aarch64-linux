...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.6.0/aarch64-linux")
  ...
  CONFIG["INSTALL"] = '/data/data/com.termux/files/usr/bin/applets/install -c'
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/data/data/com.termux/files/home/ruby-2.6.3-ArmLinux")
  ...
  CONFIG["configure_args"] = " '--prefix=/data/data/com.termux/files/home/ruby-2.6.3-ArmLinux'"
  ...
  CONFIG["arch"] = "aarch64-linux"
  CONFIG["sitearchincludedir"] = "$(includedir)/$(sitearch)"
  CONFIG["archincludedir"] = "$(includedir)/$(arch)"
  CONFIG["sitearchlibdir"] = "$(libdir)/$(sitearch)"
  CONFIG["archlibdir"] = "$(libdir)/$(arch)"
  CONFIG["libdirname"] = "libdir"
  CONFIG["RUBY_EXEC_PREFIX"] = "/data/data/com.termux/files/home/ruby-2.6.3-ArmLinux"
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-lz -lpthread -lrt -lrt -ldl -lm "
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "clang version 8.0.0 (tags/RELEASE_800/final)\nTarget: aarch64-unknown-linux-android\nThread model: posix\nInstalledDir: /data/data/com.termux/files/usr/bin"
  ...
  CONFIG["LD"] = "ld"
  CONFIG["GCC"] = "yes"
  CONFIG["EGREP"] = "/data/data/com.termux/files/usr/bin/applets/grep -E"
  CONFIG["GREP"] = "/data/data/com.termux/files/usr/bin/applets/grep"
  CONFIG["CPP"] = "$(CC) -E"
  ...
  CONFIG["host"] = "aarch64-unknown-linux-gnu"
  ...
  CONFIG["build"] = "aarch64-unknown-linux-gnu"
