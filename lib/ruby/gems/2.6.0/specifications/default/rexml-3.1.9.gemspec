...
Gem::Specification.new do |s|
  ...
  s.files = ["rexml/attlistdecl.rb".freeze, "rexml/attribute.rb".freeze, "rexml/cdata.rb".freeze, "rexml/child.rb".freeze, "rexml/comment.rb".freeze, "rexml/doctype.rb".freeze, "rexml/document.rb".freeze, "rexml/dtd/attlistdecl.rb".freeze, "rexml/dtd/dtd.rb".freeze, "rexml/dtd/elementdecl.rb".freeze, "rexml/dtd/entitydecl.rb".freeze, "rexml/dtd/notationdecl.rb".freeze, "rexml/element.rb".freeze, "rexml/encoding.rb".freeze, "rexml/entity.rb".freeze, "rexml/formatters/default.rb".freeze, "rexml/formatters/pretty.rb".freeze, "rexml/formatters/transitive.rb".freeze, "rexml/functions.rb".freeze, "rexml/instruction.rb".freeze, "rexml/light/node.rb".freeze, "rexml/namespace.rb".freeze, "rexml/node.rb".freeze, "rexml/output.rb".freeze, "rexml/parent.rb".freeze, "rexml/parseexception.rb".freeze, "rexml/parsers/baseparser.rb".freeze, "rexml/parsers/lightparser.rb".freeze, "rexml/parsers/pullparser.rb".freeze, "rexml/parsers/sax2parser.rb".freeze, "rexml/parsers/streamparser.rb".freeze, "rexml/parsers/treeparser.rb".freeze, "rexml/parsers/ultralightparser.rb".freeze, "rexml/parsers/xpathparser.rb".freeze, "rexml/quickpath.rb".freeze, "rexml/rexml.rb".freeze, "rexml/sax2listener.rb".freeze, "rexml/security.rb".freeze, "rexml/source.rb".freeze, "rexml/streamlistener.rb".freeze, "rexml/syncenumerator.rb".freeze, "rexml/text.rb".freeze, "rexml/undefinednamespaceexception.rb".freeze, "rexml/validation/relaxng.rb".freeze, "rexml/validation/validation.rb".freeze, "rexml/validation/validationexception.rb".freeze, "rexml/xmldecl.rb".freeze, "rexml/xmltokens.rb".freeze, "rexml/xpath.rb".freeze, "rexml/xpath_parser.rb".freeze]
