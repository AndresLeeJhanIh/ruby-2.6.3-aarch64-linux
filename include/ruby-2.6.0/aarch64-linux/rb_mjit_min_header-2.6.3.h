...
void* __memchr_chk(const void*, int, size_t, size_t) __attribute__((annotate("introduced_in=" "23")));
void* __memrchr_chk(const void*, int, size_t, size_t) __attribute__((annotate("introduced_in=" "23")));




char* __stpncpy_chk2(char*, const char*, size_t, size_t, size_t) __attribute__((annotate("introduced_in=" "21")));
char* __strncpy_chk2(char*, const char*, size_t, size_t, size_t) __attribute__((annotate("introduced_in=" "21")));




size_t __strlcpy_chk(char*, const char*, size_t, size_t) __attribute__((annotate("introduced_in=" "17")));
size_t __strlcat_chk(char*, const char*, size_t, size_t) __attribute__((annotate("introduced_in=" "17")));
...
void* memcpy(void* const dst __attribute__((pass_object_size(0))), const void* src, size_t copy_amount)
        ...
        __attribute__((diagnose_if(__builtin_object_size(((dst)), (0)) != ((size_t) -1) && __builtin_object_size(((dst)), (0)) < copy_amount, "'memcpy' called with size bigger than buffer", "error"))) {
...
void* memmove(void* const dst __attribute__((pass_object_size(0))), const void* src, size_t len)
        __attribute__((overloadable))
        __attribute__((diagnose_if(__builtin_object_size(((dst)), (0)) != ((size_t) -1) && __builtin_object_size(((dst)), (0)) < len, "'memmove' called with size bigger than buffer", "error"))) {
...
static __inline__ __attribute__((__always_inline__))
char* strcat(char* const dst __attribute__((pass_object_size(1))), const char* src) __attribute__((overloadable)) {
    return __builtin___strcat_chk(dst, src, __builtin_object_size(((dst)), (1)));
}

static __inline__ __attribute__((__always_inline__))
char* strncat(char* const dst __attribute__((pass_object_size(1))), const char* src, size_t n) __attribute__((overloadable)) {
    return __builtin___strncat_chk(dst, src, n, __builtin_object_size(((dst)), (1)));
}

static __inline__ __attribute__((__always_inline__))
void* memset(void* const s __attribute__((pass_object_size(0))), int c, size_t n)
        __attribute__((overloadable))
        __attribute__((diagnose_if(__builtin_object_size(((s)), (0)) != ((size_t) -1) && __builtin_object_size(((s)), (0)) < n, "'memset' called with size bigger than buffer", "error")))
...
static __inline__ __attribute__((__always_inline__))
size_t strlcpy(char* const dst __attribute__((pass_object_size(1))), const char* src, size_t size) __attribute__((overloadable)) {
...
static __inline__ __attribute__((__always_inline__))
size_t strlcat(char* const dst __attribute__((pass_object_size(1))), const char* src, size_t size) __attribute__((overloadable)) {
    size_t bos = __builtin_object_size(((dst)), (1));
...
static __inline__ __attribute__((__always_inline__))
size_t strlen(const char* const s __attribute__((pass_object_size(1))))
        __attribute__((overloadable)) __attribute__((enable_if(__builtin_strlen(s) != -1ULL, "enabled if s is a known good string."))) {
...
size_t __fread_chk(void*, size_t, size_t, FILE*, size_t) __attribute__((annotate("introduced_in=" "24")));
size_t __fwrite_chk(const void*, size_t, size_t, FILE*, size_t) __attribute__((annotate("introduced_in=" "24")));
...
static __inline__ __attribute__((__always_inline__)) __attribute__((__format__(printf, 2, 0)))
...
size_t fread(void* const __attribute__((pass_object_size(0))) buf, size_t size, size_t count, FILE* stream)
        ...
        __attribute__((diagnose_if(__builtin_object_size(((buf)), (1)) != ((size_t) -1) && size * count > __builtin_object_size(((buf)), (1)), "in call to 'fread', size * count is too large for the given buffer", "error"))) {
...
size_t fwrite(const void* const __attribute__((pass_object_size(0))) buf, size_t size, size_t count, FILE* stream)
        ...
        __attribute__((diagnose_if(__builtin_object_size(((buf)), (1)) != ((size_t) -1) && size * count > __builtin_object_size(((buf)), (1)), "in call to 'fwrite', size * count is too large for the given buffer", "error"))) {
...
char* fgets(char* const __attribute__((pass_object_size(1))) dest, int size, FILE* stream)
        ...
        __attribute__((diagnose_if(size > __builtin_object_size(((dest)), (1)), "in call to 'fgets', size is larger than the destination buffer", "error"))) {
...
mode_t __umask_chk(mode_t) __attribute__((annotate("introduced_in=" "18")));
...
int mkfifoat(int __dir_fd, const char* __path, mode_t __mode) __attribute__((annotate("introduced_in=" "23")));
...
intmax_t imaxabs(intmax_t __i) __attribute__((__const__)) __attribute__((annotate("introduced_in=" "19")));
imaxdiv_t imaxdiv(intmax_t __numerator, intmax_t __denominator) __attribute__((__const__)) __attribute__((annotate("introduced_in=" "19")));
...
intmax_t wcstoimax(const wchar_t* __s, wchar_t** __end_ptr, int __base) __attribute__((annotate("introduced_in=" "21")));
uintmax_t wcstoumax(const wchar_t* __s, wchar_t** __end_ptr, int __base) __attribute__((annotate("introduced_in=" "21")));
...
char* getcwd(char* const __attribute__((pass_object_size(1))) buf, size_t size)
        __attribute__((overloadable))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (1))) != ((size_t) -1) && (size) > (__builtin_object_size(((buf)), (1))), "in call to '" "getcwd" "', '" "size" "' bytes overflows the given object", "error"))) {
...
ssize_t pread(int fd, void* const __attribute__((pass_object_size(0))) buf, size_t count, off_t offset)
        __attribute__((overloadable))
        __attribute__((diagnose_if((count) > 9223372036854775807L, "in call to '" "pread" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (count) > (__builtin_object_size(((buf)), (0))), "in call to '" "pread" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
...
ssize_t pread64(int fd, void* const __attribute__((pass_object_size(0))) buf, size_t count, off64_t offset)
        __attribute__((overloadable))
        __attribute__((diagnose_if((count) > 9223372036854775807L, "in call to '" "pread64" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (count) > (__builtin_object_size(((buf)), (0))), "in call to '" "pread64" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
...
ssize_t pwrite(int fd, const void* const __attribute__((pass_object_size(0))) buf, size_t count, off_t offset)
        __attribute__((overloadable))
        __attribute__((diagnose_if((count) > 9223372036854775807L, "in call to '" "pwrite" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (count) > (__builtin_object_size(((buf)), (0))), "in call to '" "pwrite" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
...
ssize_t pwrite64(int fd, const void* const __attribute__((pass_object_size(0))) buf, size_t count, off64_t offset)
        __attribute__((overloadable))
        __attribute__((diagnose_if((count) > 9223372036854775807L, "in call to '" "pwrite64" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (count) > (__builtin_object_size(((buf)), (0))), "in call to '" "pwrite64" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
...
ssize_t read(int fd, void* const __attribute__((pass_object_size(0))) buf, size_t count)
        __attribute__((overloadable))
        __attribute__((diagnose_if((count) > 9223372036854775807L, "in call to '" "read" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (count) > (__builtin_object_size(((buf)), (0))), "in call to '" "read" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
...
ssize_t write(int fd, const void* const __attribute__((pass_object_size(0))) buf, size_t count)
        __attribute__((overloadable))
        __attribute__((diagnose_if((count) > 9223372036854775807L, "in call to '" "write" "', '" "count" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (0))) != ((size_t) -1) && (count) > (__builtin_object_size(((buf)), (0))), "in call to '" "write" "', '" "count" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (0));
...
ssize_t readlink(const char* path, char* const __attribute__((pass_object_size(1))) buf, size_t size)
        __attribute__((overloadable))
        __attribute__((diagnose_if((size) > 9223372036854775807L, "in call to '" "readlink" "', '" "size" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (1))) != ((size_t) -1) && (size) > (__builtin_object_size(((buf)), (1))), "in call to '" "readlink" "', '" "size" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (1));
...
ssize_t readlinkat(int dirfd, const char* path, char* const __attribute__((pass_object_size(1))) buf, size_t size)
        __attribute__((overloadable))
        __attribute__((diagnose_if((size) > 9223372036854775807L, "in call to '" "readlinkat" "', '" "size" "' must be <= SSIZE_MAX", "error")))
        __attribute__((diagnose_if((__builtin_object_size(((buf)), (1))) != ((size_t) -1) && (size) > (__builtin_object_size(((buf)), (1))), "in call to '" "readlinkat" "', '" "size" "' bytes overflows the given object", "error"))) {
    size_t bos = __builtin_object_size(((buf)), (1));
...
float tgammaf(float __x) __attribute__((annotate("introduced_in_arm=" "13"))) __attribute__((annotate("introduced_in_mips=" "13"))) __attribute__((annotate("introduced_in_x86=" "9")));
...
double nan(const char* __kind) __attribute__((__const__)) __attribute__((annotate("introduced_in_arm=" "13"))) __attribute__((annotate("introduced_in_mips=" "13"))) __attribute__((annotate("introduced_in_x86=" "9")));
float nanf(const char* __kind) __attribute__((__const__)) __attribute__((annotate("introduced_in_arm=" "13"))) __attribute__((annotate("introduced_in_mips=" "13"))) __attribute__((annotate("introduced_in_x86=" "9")));
...
long double lgammal_r(long double __x, int* __sign) __attribute__((annotate("introduced_in=" "23")));
...
rb_scan_args_set(int argc, const VALUE *argv,
   ...
   VALUE *vars[], char *fmt __attribute__ ((unused)), int varc __attribute__ ((unused)))
    ...
    __attribute__((diagnose_if((!((unsigned char)((fmt[0])-'0')<10) ? (fmt[0]!='*' ? (!((unsigned char)((fmt[0])-'0')<10) ? (fmt[0]!=':' ? (fmt[0]!='&' ? (fmt[0] ? 0 : (0)) : (fmt[0 +1] ? 0 : (0 +1))) : (fmt[0 +1]!='&' ? (fmt[0 +1] ? 0 : (0 +1)) : (fmt[0 +1 +1] ? 0 : (0 +1 +1)))) : (fmt[0 +1]!=':' ? (fmt[0 +1]!='&' ? (fmt[0 +1] ? 0 : (0 +(fmt[0]-'0'))) : (fmt[0 +1 +1] ? 0 : (0 +(fmt[0]-'0')+1))) : (fmt[0 +1 +1]!='&' ? (fmt[0 +1 +1] ? 0 : (0 +(fmt[0]-'0')+1)) : (fmt[0 +1 +1 +1] ? 0 : (0 +(fmt[0]-'0')+1 +1))))) : (!((unsigned char)((fmt[0 +1])-'0')<10) ? (fmt[0 +1]!=':' ? (fmt[0 +1]!='&' ? (fmt[0 +1] ? 0 : (0 +1)) : (fmt[0 +1 +1] ? 0 : (0 +1 +1))) : (fmt[0 +1 +1]!='&' ? (fmt[0 +1 +1] ? 0 : (0 +1 +1)) : (fmt[0 +1 +1 +1] ? 0 : (0 +1 +1 +1)))) : (fmt[0 +1 +1]!=':' ? (fmt[0 +1 +1]!='&' ? (fmt[0 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0'))) : (fmt[0 +1 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0')+1))) : (fmt[0 +1 +1 +1]!='&' ? (fmt[0 +1 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0')+1)) : (fmt[0 +1 +1 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0')+1 +1)))))) : (!((unsigned char)((fmt[1])-'0')<10) ? (fmt[1]!='*' ? (!((unsigned char)((fmt[1])-'0')<10) ? (fmt[1]!=':' ? (fmt[1]!='&' ? (fmt[1] ? 0 : (fmt[0]-'0')) : (fmt[1 +1] ? 0 : (fmt[0]-'0'+1))) : (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+1)) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1)))) : (fmt[1 +1]!=':' ? (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0'))) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0')+1))) : (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0')+1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0')+1 +1))))) : (!((unsigned char)((fmt[1 +1])-'0')<10) ? (fmt[1 +1]!=':' ? (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+1)) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1))) : (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1 +1)))) : (fmt[1 +1 +1]!=':' ? (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0'))) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0')+1))) : (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0')+1)) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0')+1 +1)))))) : (fmt[1 +1]!='*' ? (!((unsigned char)((fmt[1 +1])-'0')<10) ? (fmt[1 +1]!=':' ? (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0')) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1))) : (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1)))) : (fmt[1 +1 +1]!=':' ? (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0'))) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0')+1))) : (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0')+1)) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0')+1 +1))))) : (!((unsigned char)((fmt[1 +1 +1])-'0')<10) ? (fmt[1 +1 +1]!=':' ? (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1))) : (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1)) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1 +1)))) : (fmt[1 +1 +1 +1]!=':' ? (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0'))) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0')+1))) : (fmt[1 +1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0')+1)) : (fmt[1 +1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0')+1 +1))))))))==0,"bad scan arg format","error")))
    __attribute__((diagnose_if((!((unsigned char)((fmt[0])-'0')<10) ? (fmt[0]!='*' ? (!((unsigned char)((fmt[0])-'0')<10) ? (fmt[0]!=':' ? (fmt[0]!='&' ? (fmt[0] ? 0 : (0)) : (fmt[0 +1] ? 0 : (0 +1))) : (fmt[0 +1]!='&' ? (fmt[0 +1] ? 0 : (0 +1)) : (fmt[0 +1 +1] ? 0 : (0 +1 +1)))) : (fmt[0 +1]!=':' ? (fmt[0 +1]!='&' ? (fmt[0 +1] ? 0 : (0 +(fmt[0]-'0'))) : (fmt[0 +1 +1] ? 0 : (0 +(fmt[0]-'0')+1))) : (fmt[0 +1 +1]!='&' ? (fmt[0 +1 +1] ? 0 : (0 +(fmt[0]-'0')+1)) : (fmt[0 +1 +1 +1] ? 0 : (0 +(fmt[0]-'0')+1 +1))))) : (!((unsigned char)((fmt[0 +1])-'0')<10) ? (fmt[0 +1]!=':' ? (fmt[0 +1]!='&' ? (fmt[0 +1] ? 0 : (0 +1)) : (fmt[0 +1 +1] ? 0 : (0 +1 +1))) : (fmt[0 +1 +1]!='&' ? (fmt[0 +1 +1] ? 0 : (0 +1 +1)) : (fmt[0 +1 +1 +1] ? 0 : (0 +1 +1 +1)))) : (fmt[0 +1 +1]!=':' ? (fmt[0 +1 +1]!='&' ? (fmt[0 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0'))) : (fmt[0 +1 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0')+1))) : (fmt[0 +1 +1 +1]!='&' ? (fmt[0 +1 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0')+1)) : (fmt[0 +1 +1 +1 +1] ? 0 : (0 +1 +(fmt[0 +1]-'0')+1 +1)))))) : (!((unsigned char)((fmt[1])-'0')<10) ? (fmt[1]!='*' ? (!((unsigned char)((fmt[1])-'0')<10) ? (fmt[1]!=':' ? (fmt[1]!='&' ? (fmt[1] ? 0 : (fmt[0]-'0')) : (fmt[1 +1] ? 0 : (fmt[0]-'0'+1))) : (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+1)) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1)))) : (fmt[1 +1]!=':' ? (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0'))) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0')+1))) : (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0')+1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+(fmt[1]-'0')+1 +1))))) : (!((unsigned char)((fmt[1 +1])-'0')<10) ? (fmt[1 +1]!=':' ? (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+1)) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1))) : (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +1 +1)))) : (fmt[1 +1 +1]!=':' ? (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0'))) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0')+1))) : (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0')+1)) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+1 +(fmt[1 +1]-'0')+1 +1)))))) : (fmt[1 +1]!='*' ? (!((unsigned char)((fmt[1 +1])-'0')<10) ? (fmt[1 +1]!=':' ? (fmt[1 +1]!='&' ? (fmt[1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0')) : (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1))) : (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1)))) : (fmt[1 +1 +1]!=':' ? (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0'))) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0')+1))) : (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0')+1)) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+(fmt[1 +1]-'0')+1 +1))))) : (!((unsigned char)((fmt[1 +1 +1])-'0')<10) ? (fmt[1 +1 +1]!=':' ? (fmt[1 +1 +1]!='&' ? (fmt[1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1)) : (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1))) : (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1)) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +1 +1)))) : (fmt[1 +1 +1 +1]!=':' ? (fmt[1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0'))) : (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0')+1))) : (fmt[1 +1 +1 +1 +1]!='&' ? (fmt[1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0')+1)) : (fmt[1 +1 +1 +1 +1 +1] ? 0 : (fmt[0]-'0'+fmt[1]-'0'+1 +(fmt[1 +1 +1]-'0')+1 +1))))))))!=varc,"variable argument length doesn't match","error")))
...
{
 ((!list_empty_(h, "./ccan/list/list.h" ":" "328")) ? ((void) (0)) : __assert2("./ccan/list/list.h", 328, __PRETTY_FUNCTION__, "!list_empty(h)"));
...
int unshare(int __flags) __attribute__((annotate("introduced_in=" "17")));


int sched_getcpu(void) __attribute__((annotate("introduced_in=" "12")));


int setns(int __fd, int __ns_type) __attribute__((annotate("introduced_in=" "21")));
...
int sched_setaffinity(pid_t __pid, size_t __set_size, const cpu_set_t* __set) __attribute__((annotate("introduced_in=" "12")));
int sched_getaffinity(pid_t __pid, size_t __set_size, cpu_set_t* __set) __attribute__((annotate("introduced_in=" "12")));
...
cpu_set_t* __sched_cpualloc(size_t __count) __attribute__((annotate("introduced_in=" "12")));
void __sched_cpufree(cpu_set_t* __set) __attribute__((annotate("introduced_in=" "12")));
...
int __sched_cpucount(size_t __set_size, const cpu_set_t* __set) __attribute__((annotate("introduced_in=" "12")));
...
int pthread_atfork(void (*__prepare)(void), void (*__parent)(void), void (*__child)(void)) __attribute__((annotate("introduced_in=" "12")));
...
int pthread_condattr_getclock(const pthread_condattr_t* __attr, clockid_t* __clock) __attribute__((annotate("introduced_in=" "21")));
...
int pthread_condattr_setclock(pthread_condattr_t* __attr, clockid_t __clock) __attribute__((annotate("introduced_in=" "21")));
...
pid_t pthread_gettid_np(pthread_t __pthread) __attribute__((annotate("introduced_in=" "21")));
...
int pthread_rwlockattr_getkind_np(const pthread_rwlockattr_t* __attr, int* __kind)
  __attribute__((annotate("introduced_in=" "23")));
int pthread_rwlockattr_setkind_np(pthread_rwlockattr_t* __attr, int __kind) __attribute__((annotate("introduced_in=" "23")));
...
int pthread_barrierattr_init(pthread_barrierattr_t* __attr) __attribute__((annotate("introduced_in=" "24")));
int pthread_barrierattr_destroy(pthread_barrierattr_t* __attr) __attribute__((annotate("introduced_in=" "24")));
int pthread_barrierattr_getpshared(const pthread_barrierattr_t* __attr, int* __shared) __attribute__((annotate("introduced_in=" "24")));
int pthread_barrierattr_setpshared(pthread_barrierattr_t* __attr, int __shared) __attribute__((annotate("introduced_in=" "24")));



int pthread_barrier_init(pthread_barrier_t* __barrier, const pthread_barrierattr_t* __attr, unsigned __count) __attribute__((annotate("introduced_in=" "24")));
int pthread_barrier_destroy(pthread_barrier_t* __barrier) __attribute__((annotate("introduced_in=" "24")));
int pthread_barrier_wait(pthread_barrier_t* __barrier) __attribute__((annotate("introduced_in=" "24")));



int pthread_spin_destroy(pthread_spinlock_t* __spinlock) __attribute__((annotate("introduced_in=" "24")));
int pthread_spin_init(pthread_spinlock_t* __spinlock, int __shared) __attribute__((annotate("introduced_in=" "24")));
int pthread_spin_lock(pthread_spinlock_t* __spinlock) __attribute__((annotate("introduced_in=" "24")));
int pthread_spin_trylock(pthread_spinlock_t* __spinlock) __attribute__((annotate("introduced_in=" "24")));
int pthread_spin_unlock(pthread_spinlock_t* __spinlock) __attribute__((annotate("introduced_in=" "24")));
...
int sigsetjmp(sigjmp_buf __env, int __save_signal_mask)
    __attribute__((annotate("introduced_in_arm=" "9"))) __attribute__((annotate("introduced_in_mips=" "12"))) __attribute__((annotate("introduced_in_x86=" "12")));
...
uint32_t htonl(uint32_t __x) __attribute__((__const__)) __attribute__((annotate("introduced_in=" "21")));
uint16_t htons(uint16_t __x) __attribute__((__const__)) __attribute__((annotate("introduced_in=" "21")));
uint32_t ntohl(uint32_t __x) __attribute__((__const__)) __attribute__((annotate("introduced_in=" "21")));
uint16_t ntohs(uint16_t __x) __attribute__((__const__)) __attribute__((annotate("introduced_in=" "21")));
...
CREF_REFINEMENTS_SET(rb_cref_t *cref, VALUE refs)
{
    __extension__({
;
; typeof(rb_obj_write((VALUE)(cref), (VALUE *)(&cref->refinements), (VALUE)(refs), "./eval_intern.h", 237)) unaligned_member_access_result = (rb_obj_write((VALUE)(cref), (VALUE *)(&cref->refinements), (VALUE)(refs), "./eval_intern.h", 237));
...
vm_bind_update_env(VALUE bindval, rb_binding_t *bind, VALUE envval)
{
    ...
    __extension__({
;
; typeof(rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.code.iseq), (VALUE)(env->iseq), "./vm.c", 299)) unaligned_member_access_result = (rb_obj_write((VALUE)(bindval), (VALUE *)(&bind->block.as.captured.code.iseq), (VALUE)(env->iseq), "./vm.c", 299));
; unaligned_member_access_result; });
...
lep_svar_write(const rb_execution_context_t *ec, const VALUE *lep, const struct vm_svar *svar)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(rb_ec_thread_ptr(ec)->self), (VALUE *)(&ec->root_svar), (VALUE)(svar), "./vm_insnhelper.c", 441)) unaligned_member_access_result = (rb_obj_write((VALUE)(rb_ec_thread_ptr(ec)->self), (VALUE *)(&ec->root_svar), (VALUE)(svar), "./vm_insnhelper.c", 441));
; unaligned_member_access_result; });
    }
}
...
lep_svar_set(const rb_execution_context_t *ec, const VALUE *lep, rb_num_t key, VALUE val)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->lastline), (VALUE)(val), "./vm_insnhelper.c", 487)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->lastline), (VALUE)(val), "./vm_insnhelper.c", 487));
; unaligned_member_access_result; });
 return;
      case VM_SVAR_BACKREF:
 __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->backref), (VALUE)(val), "./vm_insnhelper.c", 490)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->backref), (VALUE)(val), "./vm_insnhelper.c", 490));
; unaligned_member_access_result; });
 return;
      default: {
 ...
 if (!((VALUE)(ary) != ((VALUE)RUBY_Qnil))) {
     __extension__({
;
; typeof(rb_obj_write((VALUE)(svar), (VALUE *)(&svar->others), (VALUE)(ary = rb_ary_new()), "./vm_insnhelper.c", 496)) unaligned_member_access_result = (rb_obj_write((VALUE)(svar), (VALUE *)(&svar->others), (VALUE)(ary = rb_ary_new()), "./vm_insnhelper.c", 496));
; unaligned_member_access_result; });
 }
...
cref_replace_with_duplicated_cref_each_frame(const VALUE *vptr, int can_be_svar, VALUE parent)
{
 ...
 switch (imemo_type(v)) {
  ...
  __extension__({
;
; typeof(rb_obj_write((VALUE)(parent), (VALUE *)(vptr), (VALUE)(new_cref), "./vm_insnhelper.c", 671)) unaligned_member_access_result = (rb_obj_write((VALUE)(parent), (VALUE *)(vptr), (VALUE)(new_cref), "./vm_insnhelper.c", 671));
; unaligned_member_access_result; });
     }
     else {
...
vm_setivar(VALUE obj, ID id, VALUE val, IC ic, struct rb_call_cache *cc, int is_attr) {
 ...
 if ((__builtin_expect(!!((!is_attr && (ic->ic_serial == ((((struct RClass*)(klass))->ptr)->class_serial))) || ( is_attr && (cc->aux.index > 0))), 1))) {
  ...
  __extension__({
;
; typeof(rb_obj_write((VALUE)(obj), (VALUE *)(&ptr[index]), (VALUE)(val), "./vm_insnhelper.c", 1025)) unaligned_member_access_result = (rb_obj_write((VALUE)(obj), (VALUE *)(&ptr[index]), (VALUE)(val), "./vm_insnhelper.c", 1025));
; unaligned_member_access_result; });
  ((void)0);
  return val;
     }
...
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[--args->rest_index]), (VALUE)(_v), "./vm_args.c", 150)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[--args->rest_index]), (VALUE)(_v), "./vm_args.c", 150));
...
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)(_v), "./vm_args.c", 231)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[len - 1]), (VALUE)(_v), "./vm_args.c", 231));
; unaligned_member_access_result; }); rb_array_ptr_use_end(_ary, 1); } while (0);
  }
  else {
      arg_rest_dup(args);
...
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[0]), (VALUE)(_v), "./vm_args.c", 903)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[0]), (VALUE)(_v), "./vm_args.c", 903));
; unaligned_member_access_result; }); rb_array_ptr_use_end(_ary, 1); } while (0);
                    do { const VALUE _ary = (callback_arg); const VALUE _v = (ref); VALUE *ptr = (VALUE *)rb_array_ptr_use_start(_ary, 1); __extension__({
;
; typeof(rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[1]), (VALUE)(_v), "./vm_args.c", 904)) unaligned_member_access_result = (rb_obj_write((VALUE)(_ary), (VALUE *)(&ptr[1]), (VALUE)(_v), "./vm_args.c", 904));
; unaligned_member_access_result; }); rb_array_ptr_use_end(_ary, 1); } while (0);
...
aliased_callable_method_entry(const rb_callable_method_entry_t *me)
{
 ...
 if (me->def->alias_count + me->def->complemented_count == 0) {
     __extension__({
;
; typeof(rb_obj_write((VALUE)(me), (VALUE *)(&me->def->body.alias.original_me), (VALUE)(cme), "./vm_insnhelper.c", 2195)) unaligned_member_access_result = (rb_obj_write((VALUE)(me), (VALUE *)(&me->def->body.alias.original_me), (VALUE)(cme), "./vm_insnhelper.c", 2195));
; unaligned_member_access_result; });
 }
 else {
...
vm_opt_newarray_max(rb_num_t num, const VALUE *ptr)
{
 ...
 return __extension__({ const int rb_funcall_argc = (0); const VALUE rb_funcall_args[] = {}; const int rb_funcall_nargs = (int)(sizeof(rb_funcall_args) / sizeof(VALUE)); rb_funcallv(ary, idMax, __builtin_choose_expr(__builtin_constant_p(rb_funcall_argc), (((rb_funcall_argc) == 0 ? (rb_funcall_nargs) <= 1 : (rb_funcall_argc) == (rb_funcall_nargs)) ? (rb_funcall_argc) : ((rb_funcall_argc)/((rb_funcall_argc) == 0 ? (rb_funcall_nargs) <= 1 : (rb_funcall_argc) == (rb_funcall_nargs)))), (((rb_funcall_argc) <= (rb_funcall_nargs)) ? (rb_funcall_argc) : (rb_fatal("argc(%d) exceeds actual arguments(%d)", rb_funcall_argc, rb_funcall_nargs), 0))), rb_funcall_nargs ? rb_funcall_args : ((void*)0)); });
    }
}
...
vm_once_dispatch(rb_execution_context_t *ec, ISEQ iseq, ISE is)
{
 ...
 __extension__({
;
; typeof(rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "./vm_insnhelper.c", 3291)) unaligned_member_access_result = (rb_obj_write((VALUE)(ec->cfp->iseq), (VALUE *)(&is->once.value), (VALUE)(val), "./vm_insnhelper.c", 3291));
; unaligned_member_access_result; });
...
vm_case_dispatch(CDHASH hash, OFFSET else_offset, VALUE key)
{
 ...
 if (((__builtin_expect(!!((rb_current_vm()->redefined_flag[(BOP_EQQ)]&((1 << 6) | (1 << 0) | (1 << 1) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 2))) == 0), 1)))) {
  ...
  if (!__builtin_isinf(kval) && modf(kval, &kval) == 0.0) {
...
#define MB_CUR_MAX 4
#define __realpath_buf_too_small_str "'realpath' output parameter must be NULL or a pointer to a buffer with >= PATH_MAX bytes"
...
#define FD_ZERO(set) do { size_t __i; for (__i = 0; __i < sizeof(fd_set)/sizeof(fd_mask); ++__i) { (set)->fds_bits[__i] = 0; } } while (0)
...
#define __error_if_overflows_ssizet(what,fn) __clang_error_if((what) > SSIZE_MAX, "in call to '" #fn "', '" #what "' must be <= SSIZE_MAX")
#define __error_if_overflows_objectsize(what,objsize,fn) __clang_error_if((objsize) != __BIONIC_FORTIFY_UNKNOWN_SIZE && (what) > (objsize), "in call to '" #fn "', '" #what "' bytes overflows the given object")
...
#define rb_scan_args_count_end(fmt,ofs,varc,vari) (fmt[ofs] ? rb_scan_args_bad_format(fmt) : (vari))
...
#define CPU_CLR_S(cpu,setsize,set) do { size_t __cpu = (cpu); if (__cpu < 8 * (setsize)) (set)->__bits[__CPU_ELT(__cpu)] &= ~__CPU_MASK(__cpu); } while (0)
#define CPU_ISSET_S(cpu,setsize,set) (__extension__ ({ size_t __cpu = (cpu); (__cpu < 8 * (setsize)) ? ((set)->__bits[__CPU_ELT(__cpu)] & __CPU_MASK(__cpu)) != 0 : 0; }))
...
#define __CPU_OP_S(setsize,dstset,srcset1,srcset2,op) do { cpu_set_t* __dst = (dstset); const __CPU_BITTYPE* __src1 = (srcset1)->__bits; const __CPU_BITTYPE* __src2 = (srcset2)->__bits; size_t __nn = 0, __nn_max = (setsize)/sizeof(__CPU_BITTYPE); for (; __nn < __nn_max; __nn++) (__dst)->__bits[__nn] = __src1[__nn] op __src2[__nn]; } while (0)
...
#define timeradd(a,b,res) do { (res)->tv_sec = (a)->tv_sec + (b)->tv_sec; (res)->tv_usec = (a)->tv_usec + (b)->tv_usec; if ((res)->tv_usec >= 1000000) { (res)->tv_usec -= 1000000; (res)->tv_sec += 1; } } while (0)
#define timersub(a,b,res) do { (res)->tv_sec = (a)->tv_sec - (b)->tv_sec; (res)->tv_usec = (a)->tv_usec - (b)->tv_usec; if ((res)->tv_usec < 0) { (res)->tv_usec += 1000000; (res)->tv_sec -= 1; } } while (0)
...
#define pthread_cleanup_push(routine,arg) do { __pthread_cleanup_t __cleanup; __pthread_cleanup_push( &__cleanup, (routine), (arg) );
#define pthread_cleanup_pop(execute) __pthread_cleanup_pop( &__cleanup, (execute)); } while (0);
#pragma GCC visibility push(default)
#pragma GCC visibility pop
...
#define powerof2(x) ({ __typeof__(x) _x = (x); __typeof__(x) _x2; __builtin_add_overflow(_x, -1, &_x2) ? 1 : ((_x2 & _x) == 0); })
